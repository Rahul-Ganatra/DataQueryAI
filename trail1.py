...
def main():
    ...
    if st.session_state.summary:
        ...
        if st.session_state.show_summary:
            st.subheader("Summary of the Documents")
            st.write(st.session_state.summary)

            # Generate questions and answers from the summary
            if st.button("Generate Questions"):
                with st.spinner("Generating questions..."):
                    questions_answers = generate_questions_answers_from_llm(st.session_state.summary)
                    st.session_state.questions_answers = questions_answers
                    st.write(questions_answers)  # Display generated questions
